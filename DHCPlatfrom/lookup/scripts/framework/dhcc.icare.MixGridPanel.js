...
dhcc.icare.MixGridPanel = Ext.extend(Ext.grid.GridPanel, {
	...
	*/
	...
	/**!
	*@cfg {Object|Array|Ext.Button} bbarItems pagingbar上显示的按钮
	**/
	...
	*/
	...
	headerDblClick: function(){
		if(this.lookupListComponetId != ""){
			...
			if (flag==1) websys_lu('../csp/websys.component.customiselayout.csp?ID='+this.lookupListComponetId+'&CONTEXT=K'+this.listClassName+':'+this.listQueryName+"&DHCICARE=2",false);		
		}
	},
